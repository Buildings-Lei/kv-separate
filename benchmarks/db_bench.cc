...
// Size of each value
static int FLAGS_value_size = 1024*1024;
        ...
        public:
            RandomGenerator() {
                ...
                while (data_.size() < 1048576) {
                    ...
                    test::CompressibleString(&rnd, FLAGS_compression_ratio, 100*1024*1024, &piece);
                    data_.append(piece);
                }
                pos_ = 0;
            }
